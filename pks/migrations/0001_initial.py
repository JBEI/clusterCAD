# Generated by Django 2.2.3 on 2019-07-12 22:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('domain_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pks.Domain')),
                ('substrate', models.CharField(choices=[('DCP', 'DCP'), ('fatty_acid', 'fatty_acid'), ('CHC-CoA', 'CHC-CoA'), ('NH2', 'NH2'), ('3measp', '3measp'), ('benz', 'benz'), ('prop', 'prop'), ('cyclopentene', 'cyclopentene'), ('Acetyl-CoA', 'Acetyl-CoA'), ('a3abut', 'a3abut'), ('cemal', 'cemal'), ('isobutmal', 'isobutmal'), ('hexmal', 'hexmal'), ('emal', 'emal'), ('mal', 'mal'), ('trans-1,2-CPDA', 'trans-1,2-CPDA'), ('pyr', 'pyr'), ('DHCH', 'DHCH'), ('butmal', 'butmal'), ('mthz', 'mthz'), ('isobut', 'isobut'), ('guan', 'guan'), ('hmal', 'hmal'), ('shikimic_acid', 'shikimic_acid'), ('N/A', 'N/A'), ('allylmal', 'allylmal'), ('AAnon', 'AAnon'), ('PABA', 'PABA'), ('D-isobutmal', 'D-isobutmal'), ('2metbut', '2metbut'), ('ema', 'ema'), ('mxmal', 'mxmal'), ('cin', 'cin'), ('isoval', 'isoval'), ('plac', 'plac'), ('mxmal_ACP', 'mxmal_ACP'), ('mmal', 'mmal'), ('AHBA', 'AHBA'), ('PNBA', 'PNBA'), ('DHCHene', 'DHCHene')], default='mal', max_length=20)),
            ],
            bases=('pks.domain',),
        ),
        migrations.CreateModel(
