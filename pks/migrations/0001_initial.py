# Generated by Django 2.2.3 on 2019-07-25 21:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('domain_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pks.Domain')),
                ('substrate', models.CharField(choices=[('mal', 'mal'), ('DHCH', 'DHCH'), ('PABA', 'PABA'), ('fatty_acid', 'fatty_acid'), ('trans-1,2-CPDA', 'trans-1,2-CPDA'), ('CHC-CoA', 'CHC-CoA'), ('hexmal', 'hexmal'), ('guan', 'guan'), ('mthz', 'mthz'), ('isobutmal', 'isobutmal'), ('prop', 'prop'), ('D-isobutmal', 'D-isobutmal'), ('AAnon', 'AAnon'), ('ema', 'ema'), ('N/A', 'N/A'), ('DHCHene', 'DHCHene'), ('3measp', '3measp'), ('DCP', 'DCP'), ('AHBA', 'AHBA'), ('isobut', 'isobut'), ('plac', 'plac'), ('cyclopentene', 'cyclopentene'), ('cin', 'cin'), ('PNBA', 'PNBA'), ('benz', 'benz'), ('Acetyl-CoA', 'Acetyl-CoA'), ('shikimic_acid', 'shikimic_acid'), ('emal', 'emal'), ('butmal', 'butmal'), ('mmal', 'mmal'), ('mxmal_ACP', 'mxmal_ACP'), ('isoval', 'isoval'), ('mxmal', 'mxmal'), ('a3abut', 'a3abut'), ('pyr', 'pyr'), ('allylmal', 'allylmal'), ('cemal', 'cemal'), ('NH2', 'NH2'), ('hmal', 'hmal'), ('2metbut', '2metbut')], default='mal', max_length=20)),
            ],
            bases=('pks.domain',),
        ),
        migrations.CreateModel(
