# Generated by Django 2.2.3 on 2020-11-20 13:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('domain_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pks.Domain')),
                ('substrate', models.CharField(choices=[('isobut', 'isobut'), ('cyclopentene', 'cyclopentene'), ('benz', 'benz'), ('allylmal', 'allylmal'), ('isobutmal', 'isobutmal'), ('shikimic_acid', 'shikimic_acid'), ('ema', 'ema'), ('a3abut', 'a3abut'), ('butmal', 'butmal'), ('AAnon', 'AAnon'), ('fatty_acid', 'fatty_acid'), ('emal', 'emal'), ('mxmal', 'mxmal'), ('PNBA', 'PNBA'), ('AHBA', 'AHBA'), ('cin', 'cin'), ('D-isobutmal', 'D-isobutmal'), ('mxmal_ACP', 'mxmal_ACP'), ('prop', 'prop'), ('mmal', 'mmal'), ('cemal', 'cemal'), ('PABA', 'PABA'), ('DHCH', 'DHCH'), ('plac', 'plac'), ('pyr', 'pyr'), ('trans-1,2-CPDA', 'trans-1,2-CPDA'), ('CHC-CoA', 'CHC-CoA'), ('isoval', 'isoval'), ('NH2', 'NH2'), ('3measp', '3measp'), ('N/A', 'N/A'), ('hexmal', 'hexmal'), ('mthz', 'mthz'), ('DCP', 'DCP'), ('mal', 'mal'), ('guan', 'guan'), ('Acetyl-CoA', 'Acetyl-CoA'), ('hmal', 'hmal'), ('DHCHene', 'DHCHene'), ('2metbut', '2metbut')], default='mal', max_length=20)),
            ],
            bases=('pks.domain',),
        ),
        migrations.CreateModel(
