# Generated by Django 2.2.3 on 2020-11-16 22:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('domain_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='pks.Domain')),
                ('substrate', models.CharField(choices=[('mthz', 'mthz'), ('PNBA', 'PNBA'), ('isoval', 'isoval'), ('prop', 'prop'), ('allylmal', 'allylmal'), ('isobutmal', 'isobutmal'), ('ema', 'ema'), ('N/A', 'N/A'), ('cin', 'cin'), ('butmal', 'butmal'), ('a3abut', 'a3abut'), ('benz', 'benz'), ('AHBA', 'AHBA'), ('shikimic_acid', 'shikimic_acid'), ('CHC-CoA', 'CHC-CoA'), ('2metbut', '2metbut'), ('Acetyl-CoA', 'Acetyl-CoA'), ('mal', 'mal'), ('AAnon', 'AAnon'), ('3measp', '3measp'), ('DHCHene', 'DHCHene'), ('hmal', 'hmal'), ('cemal', 'cemal'), ('mxmal_ACP', 'mxmal_ACP'), ('guan', 'guan'), ('DHCH', 'DHCH'), ('mmal', 'mmal'), ('fatty_acid', 'fatty_acid'), ('plac', 'plac'), ('NH2', 'NH2'), ('DCP', 'DCP'), ('mxmal', 'mxmal'), ('hexmal', 'hexmal'), ('pyr', 'pyr'), ('PABA', 'PABA'), ('isobut', 'isobut'), ('trans-1,2-CPDA', 'trans-1,2-CPDA'), ('cyclopentene', 'cyclopentene'), ('emal', 'emal'), ('D-isobutmal', 'D-isobutmal')], default='mal', max_length=20)),
            ],
            bases=('pks.domain',),
        ),
        migrations.CreateModel(
