...
<head>
    ...
    <meta charset="utf-8">
    <title>SSSR - Documentation</title>
...
<header>
        ...
        SSSR
            ...
            <div class="class-description usertext"><p>A class encapsulating the functionality to find the smallest set of smallest rings in a graph.</p></div>
...
<article>
    ...
    <h4 class="name" id="SSSR"><span class="type-signature"></span>new SSSR<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id=".areSetsEqual"><span class="type-signature">(static) </span>areSetsEqual<span class="signature">(setA, setB)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line539">line 539</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Checks whether or not two sets are equal (contain the same elements).</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>setA</code></td>
...
<span class="param-type">Set.&lt;Number></span>
            ...
            <td class="description last"><p>A set.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>setB</code></td>
...
<div class="param-desc">
    <p>A boolean indicating whether or not the two sets are equal.</p>
</div>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id=".bondsToAtoms"><span class="type-signature">(static) </span>bondsToAtoms<span class="signature">(bonds)</span><span class="type-signature"> &rarr; {Set.&lt;Number>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line430">line 430</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Return a set of vertex indices contained in an array of bonds.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>bonds</code></td>
...
<span class="param-type">Array</span>
            ...
            <td class="description last"><p>An array of bonds. A bond is defined as [ sourceVertexId, targetVertexId ].</p></td>
        </tr>
...
<span class="param-type">Set.&lt;Number></span>
    ...
    <h4 class="name" id=".getBondCount"><span class="type-signature">(static) </span>getBondCount<span class="signature">(atoms, adjacencyMatrix)</span><span class="type-signature"> &rarr; {Number}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line448">line 448</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Returns the number of bonds within a set of atoms.</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>atoms</code></td>
...
<span class="param-type">Set.&lt;Number></span>
            ...
            <td class="description last"><p>An array of atom ids.</p></td>
        </tr>
...
<div class="param-desc">
    <p>The number of bonds in a set of atoms.</p>
</div>
...
<span class="param-type">Number</span>
    ...
    <h4 class="name" id=".getEdgeCount"><span class="type-signature">(static) </span>getEdgeCount<span class="signature">(adjacencyMatrix)</span><span class="type-signature"> &rarr; {Number}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line384">line 384</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Returns the number of edges in a graph defined by an adjacency matrix.</p>
</div>
...
<div class="param-desc">
    <p>The number of edges in the graph defined by the adjacency matrix.</p>
</div>
...
<span class="param-type">Number</span>
    ...
    <h4 class="name" id=".getEdgeList"><span class="type-signature">(static) </span>getEdgeList<span class="signature">(adjacencyMatrix)</span><span class="type-signature"> &rarr; {Array.&lt;Array>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line407">line 407</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Returns an edge list constructed form an adjacency matrix.</p>
</div>
...
<span class="param-type">Array.&lt;Array></span>
    ...
    <h4 class="name" id=".getPathIncludedDistanceMatrices"><span class="type-signature">(static) </span>getPathIncludedDistanceMatrices<span class="signature">(adjacencyMatrix)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line125">line 125</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Returnes the two path-included distance matrices used to find the sssr.</p>
</div>
...
<div class="param-desc">
    <p>The path-included distance matrices. { p1, p2 }</p>
</div>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id=".getRingCandidates"><span class="type-signature">(static) </span>getRingCandidates<span class="signature">(d, pe, pe_prime)</span><span class="type-signature"> &rarr; {Array.&lt;Array>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line280">line 280</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Get the ring candidates from the path-included distance matrices.</p>
</div>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>The distance matrix.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>A matrix containing the shortest paths.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>pe_prime</code></td>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>A matrix containing the shortest paths + one vertex.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Array></span>
    ...
    <h4 class="name" id=".getRings"><span class="type-signature">(static) </span>getRings<span class="signature">(graph, experimental<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Array.&lt;Array>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line13">line 13</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Returns an array containing arrays, each representing a ring from the smallest set of smallest rings in the graph.</p>
</div>
...
<span class="param-type"><a href="Graph.html">Graph</a></span>
            ...
            <td class="description last"><p>A Graph object.</p></td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last"><p>Whether or not to use experimental SSSR.</p></td>
        </tr>
...
<div class="param-desc">
    <p>An array containing arrays, each representing a ring from the smallest set of smallest rings in the group.</p>
</div>
...
<span class="param-type">Array.&lt;Array></span>
    ...
    <h4 class="name" id=".getSSSR"><span class="type-signature">(static) </span>getSSSR<span class="signature">(c, d, adjacencyMatrix, pe, pe_prime, arrBondCount, arrRingCount, nsssr)</span><span class="type-signature"> &rarr; {Array.&lt;Set>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line325">line 325</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Searches the candidates for the smallest set of smallest rings.</p>
</div>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>The candidates.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Array></span>
        ...
        <tr>
                ...
                <td class="name"><code>arrBondCount</code></td>
...
<span class="param-type">Uint16Array</span>
            ...
            <td class="description last"><p>A matrix containing the bond count of each vertex.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>arrRingCount</code></td>
...
<span class="param-type">Uint16Array</span>
            ...
            <td class="description last"><p>A matrix containing the number of rings associated with each vertex.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>nsssr</code></td>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>The theoretical number of rings in the graph.</p></td>
        </tr>
...
<div class="param-desc">
    <p>The smallest set of smallest rings.</p>
</div>
...
<span class="param-type">Array.&lt;Set></span>
    ...
    <h4 class="name" id=".isSupersetOf"><span class="type-signature">(static) </span>isSupersetOf<span class="signature">(setA, setB)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line560">line 560</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Checks whether or not a set (setA) is a superset of another set (setB).</p>
</div>
...
<div class="param-desc">
    <p>A boolean indicating whether or not setB is a superset of setA.</p>
</div>
...
<span class="param-type">Boolean</span>
    ...
    <h4 class="name" id=".matrixToString"><span class="type-signature">(static) </span>matrixToString<span class="signature">(matrix)</span><span class="type-signature"> &rarr; {String}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line105">line 105</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Creates a printable string from a matrix (2D array).</p>
</div>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>A 2D array.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A string representing the matrix.</p>
</div>
...
<span class="param-type">String</span>
    ...
    <h4 class="name" id=".pathSetsContain"><span class="type-signature">(static) </span>pathSetsContain<span class="signature">(pathSets, pathSet, bonds, allBonds, arrBondCount, arrRingCount)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="SSSR.js.html">SSSR.js</a>, <a href="SSSR.js.html#line473">line 473</a>
    </li></ul></dd>
...
<div class="description usertext">
    <p>Checks whether or not a given path already exists in an array of paths.</p>
</div>
...
<span class="param-type">Array.&lt;Set></span>
            ...
            <td class="description last"><p>An array of sets each representing a path.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>pathSet</code></td>
...
<span class="param-type">Set.&lt;Number></span>
            ...
            <td class="description last"><p>A set representing a path.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>The bonds associated with the current path.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>allBonds</code></td>
...
<span class="param-type">Array.&lt;Array></span>
            ...
            <td class="description last"><p>All bonds currently associated with rings in the SSSR set.</p></td>
        </tr>
...
<div class="param-desc">
    <p>A boolean indicating whether or not a give path is contained within a set.</p>
</div>
